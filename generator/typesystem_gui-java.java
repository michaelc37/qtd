...
class QInputDialog___ extends QInputDialog {
    public static double getDouble(QWidget _parent, string title, string label, double value = 0, double minValue = -2147483647, double maxValue = 2147483647, int decimals = 1, auto_ref!bool ok = false, int flags = 0) {
    ...
    {
        public static int getInt(QWidget _parent, string title, string label, int value = 0, int minValue = -2147483647, int maxValue = 2147483647, int step = 1, auto_ref!bool ok = false, int flags = 0) {
    ...
    public static string getItem(QWidget _parent, string title, string label, QList!(string) items, int current = 0, bool editable = true, auto_ref!bool ok = false, int flags = 0) {
        return getItem_private(_parent, title, label, items, current, editable, &ok, flags);
    }

    public static string getText(QWidget _parent, string title, string label, QLineEdit.EchoMode echo = QLineEdit.EchoMode.Normal, string text = null, auto_ref!bool ok = false, int flags = 0) {
        string res;
